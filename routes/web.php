...
Route::get('concurso/{slug}', array('as'=> 'concurso.slug', 'uses' => 'HomeController@contest'));
...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::post('concurso/{contest}/participar','ContestController@enterContest')->name("participar");;
